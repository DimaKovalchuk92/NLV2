...
2. LEVEL 1 — Run automated scan:
   python3 ~/.gemini/skills/skill-generator/scripts/security-scan.py <skill-path>
3. Check exit code:
...
2. **LEVEL 1** — Run automated scanner:
   ```bash
   python3 ~/.gemini/skills/skill-generator/scripts/security-scan.py <path>
   ```
...
python3 ~/.gemini/skills/skill-generator/scripts/security-scan.py <installed-path>
```
...
```bash
python3 ~/.gemini/skills/skill-generator/scripts/security-scan.py ./skill-name/
```
